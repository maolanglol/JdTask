...
#define MyAppExeName "Jlion.BrushClient.Client.exe"
#define ProcessExeName "Jlion.BrushClient.Client.exe"
...
[Files]
Source: "..\Setup\Out\Jlion.BrushClient.Client.exe"; DestDir: "{app}"; Flags: ignoreversion; 
Source: "..\Setup\Out\Jlion.BrushClient.Client.exe"; DestDir: "{app}"; Flags: ignoreversion;
;#if IncludeFramework
