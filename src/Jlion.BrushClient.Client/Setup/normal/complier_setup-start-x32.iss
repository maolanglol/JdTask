...
#define MyAppName "走地鸡"
#define MyAppVersion "1.2.9"
#define MyAppPublisher "平顶山认真网络科技有限公司"
#define MyAppURL ""
...
OutputDir=走地鸡
OutputBaseFilename=走地鸡-{#MyAppVersion}
...
[Files]
Source: "..\..\Setup\normal\Out\Jlion.BrushClient.Client.exe"; DestDir: "{app}"; Flags: ignoreversion; 
Source: "..\..\Setup\normal\Out\Jlion.BrushClient.Client.exe"; DestDir: "{app}"; Flags: ignoreversion;
;#if IncludeFramework
